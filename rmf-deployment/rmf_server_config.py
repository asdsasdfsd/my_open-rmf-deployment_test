...
config["public_url"] = "https://rmf.tfk3s.ezey.link/rmf/api/v1"
config["log_level"] = "INFO"
config["builtin_admin"] = "admin"
config["jwt_public_key"] = "/jwt-configmap/jwt-pub-key.pub"
config["oidc_url"] = "https://rmf.tfk3s.ezey.link/auth/realms/rmf-web/.well-known/openid-configuration"
config["aud"] = "dashboard"
config["iss"] = "https://rmf.tfk3s.ezey.link/auth/realms/rmf-web"

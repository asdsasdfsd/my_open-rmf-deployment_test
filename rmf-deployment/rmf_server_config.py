...
config["public_url"] = "https://45.77.171.157/rmf/api/v1"
config["log_level"] = "INFO"
config["builtin_admin"] = "admin"
config["jwt_public_key"] = "/jwt-configmap/jwt-pub-key.pub"
config["oidc_url"] = "https://45.77.171.157/auth/realms/rmf-web/.well-known/openid-configuration"
config["aud"] = "dashboard"
config["iss"] = "https://45.77.171.157/auth/realms/rmf-web"
